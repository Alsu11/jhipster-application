...
class StudentResourceIT {
    ...
    public static Student createEntity(EntityManager em) {
        Student student = new Student().firstName(DEFAULT_FIRST_NAME).lastName(DEFAULT_LAST_NAME);
        return student;
    }
    ...
    public static Student createUpdatedEntity(EntityManager em) {
        Student student = new Student().firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
        return student;
    }
    ...
    void putExistingStudent() throws Exception {
        ...
        updatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
    ...
    void partialUpdateStudentWithPatch() throws Exception {
        ...
        partialUpdatedStudent.firstName(UPDATED_FIRST_NAME).lastName(UPDATED_LAST_NAME);
