...
import { TestsService } from 'app/entities/tests/service/tests.service';
...
describe('TestsStudents Management Update Component', () => {
  ...
  describe('ngOnInit', () => {
    it('Should call Student query and add missing value', () => {
      ...
      const studentId: IStudent = { id: 3263 };
      testsStudents.studentId = studentId;

      const studentCollection: IStudent[] = [{ id: 25330 }];
    ...
    it('Should call Tests query and add missing value', () => {
      const testsStudents: ITestsStudents = { id: 456 };
      const testId: ITests = { id: 1924 };
      testsStudents.testId = testId;

      const testsCollection: ITests[] = [{ id: 32705 }];
    ...
    it('Should update editForm', () => {
      const testsStudents: ITestsStudents = { id: 456 };
      const studentId: IStudent = { id: 24800 };
      testsStudents.studentId = studentId;
      const testId: ITests = { id: 15113 };
      testsStudents.testId = testId;
